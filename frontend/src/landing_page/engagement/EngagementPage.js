...
const EngagementPage = () => {
  const categories = [
    { name: 'Traditional', path: '/engagements/traditional', image: '/media/images/search1.jpg' },
    { name: 'Modern', path: '/engagements/modern', image: '/media/images/search2.jpg' },
    { name: 'Surprise', path: '/engagements/surprise', image: '/media/images/search3.jpg' },
  ];
